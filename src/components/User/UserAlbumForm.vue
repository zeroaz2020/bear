<template>
  ...
  <ul class="card album__area">
    <li>
      <h3>메인 이미지</h3>
      <div class="img__area">
        <img
          src="@/assets/images/img_yoga.png"
          alt="yoga" />
        <button
          type="button"
          @click="clicked">
  ...
  <ul class="card album">
    ...
    <li>
      <div class="img__area">
        <img
          src="@/assets/images/img_best.png"
          alt="img_best" />
        <button
          type="button"
          @click="clicked">
    ...
    <li>
      <div class="img__area">
        <img
          src="@/assets/images/img_yoga2.png"
          alt="img_yoga2" />
        <button
          type="button"
          @click="clicked">
    ...
    <li>
      <div class="img__area">
        <img
          src="@/assets/images/img_action.png"
          alt="img_action" />
        <button
          type="button"
          @click="clicked">
    ...
    <li>
      <div class="img__area">
        <img
          src="@/assets/images/img_woman.png"
          alt="img_woman" />
        <button
          type="button"
          @click="clicked">
